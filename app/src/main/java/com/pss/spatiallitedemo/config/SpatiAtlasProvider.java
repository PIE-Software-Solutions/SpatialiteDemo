...
import com.pss.spatiallitedemo.R;
...
import static com.pss.spatiallitedemo.config.SpatiAtlasContract.SystemInfoColumns.HAS_GEOS;
...
import static com.pss.spatiallitedemo.config.SpatiAtlasContract.SystemInfoColumns.HAS_PROJ;
...
public class SpatiAtlasProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, "towns", TOWNS);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case TOWNS: {
                ...
                final String wkbGeom = sqlFunc("ST_Distance", resultGeom, "GeomFromText('POINT(9.57945 45.71668)', 4326)");
            ...
            /*case TOWNS: {
				...
				cursor = builder
						.table(table)
						//.map(SpatiAtlasContract.GeometryColumn.GEOMETRY, wkbGeom)
						.where(selection, selectionArgs)
						.query(db, projection, groupBy, having, sortOrder, limit);
				cursor.setNotificationUri(cr, uri);
				return cursor;
